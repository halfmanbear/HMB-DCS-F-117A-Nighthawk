local function GUIDED_BOMBS(main, fm, autopilot, tgdata)
    local t = main
...
local gbu_31_v3b = {
    ...
    user_name = _("GBU-31-V3B 2000lb JDAM"),
    scheme = "bomb_jdam",
...
declare_weapon(gbu_31_v3b)

declare_loadout(
    {
        category = CAT_BOMBS,
        CLSID = "GBU31_V3B_JDAM",
        attribute = gbu_31_v3b.wsTypeOfWeapon,
        Count = 1,
        Cx_pil = gbu_31_v3b.Cx,
        Picture = "gbu31.png",
        displayName = gbu_31_v3b.user_name,
        Weight = gbu_31_v3b.mass,
